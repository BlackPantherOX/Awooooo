...
const Welcome = () => {
  return (
    <div className="h-screen w-full overflow-hidden relative before:absolute before:inset-0 before:bg-hotel before:bg-center before:bg-cover before:bg-no-repeat">
      {/* "" */}
      ...
      <div className="w-full h-full relative flex flex-col items-center justify-center bg-blue-700 bg-opacity-70 pt-60 lg:pt-48">
        ...
        <div className="lg:w-2/4 text-white p-3 lg:p-10 text-center leading-8 font-thin tracking-wider text-lg">
          <span className="block font-light">Jangu Tunyumirweeeeeeeee!! </span>
